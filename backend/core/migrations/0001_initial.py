# Generated by Django 5.0.6 on 2026-09-22 14:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('freelancer', 'Freelancer'), ('business', 'Small Business')], default='freelancer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform', models.CharField(choices=[('teams', 'Microsoft Teams'), ('zoom', 'Zoom'), ('skype', 'Skype')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('transcript', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='scope_of_truth', to='core.transcript')),
            ],
        ),
    ]
